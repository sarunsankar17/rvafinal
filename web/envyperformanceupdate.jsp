...
<html>
	<head><title>Envysion Performance Update</title>
	...
	<div class="main-container">
			...
			<div class="center-body">
				  ...
				  <div class="lmenu-list">	
                            ...
                            <ul class="lmenu">
                                    ...
                                    %>
                                        ...
                                        <li><a id="cur" href="envysionchecklist.jsp">Envysion Clients</a></li>
				...
				<div class="right-container">
                              <%@include file="jspfiles/envyperformanceupdate1.jsp" %>

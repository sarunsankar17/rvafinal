...
<html>
	<head><title>AS Audits Insert/Update</title>
	...
	<div class="main-container">
			...
			<div class="center-body">
				<div class="left-menu">
				  ...
				  <div class="lmenu-list">	
						...
						<li><a href="asmissedvalues.jsp">AS Missed Data's</a></li>
						 <li><a id="cur" href="asauditsinsertupdate.jsp">AS Audit Insert/Update</a></li>
				...
				<div class="right-container">
                              <%@include file="jspfiles/asauditsinsertupdate1.jsp" %>

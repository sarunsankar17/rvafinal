...
<html>
	<head><title>RVA Home</title>
            <link href="cssfiles/default.css" rel="stylesheet" type="text/css">
             ...
             <script src="jsfiles/rvaattendancejs.js"></script>
             <style>
               .rvaattandance{
                 width:auto;
               }
               ...
               .rvaattandance{
                ...
                .rvaattandance th ,.rvaattandance td{
                 width:75px;
                }
                .rvaattandance tr,.rvaattandance th, .rvaattandance td{
                  border: 2px solid black;
                }
                .rvaattandance tr:last-child td:last-child{
                  align:center;
                }
	...
	<div class="main-container">
			...
			<div class="body-container">
				<div class="header">
                                    ...
                                    String profpicture=logbean.getProfpicture();
                                    %>
				<div class="logo">
                                    <div class="l-logo">
                              ...
                              <div id="profpic">
                                <!--<img src="<%=profpicture%>" alt="Profile Image">-->
                                    ...
                                    <div class="r-uname">
                                        <div class="uname">
                                          <%
                                          String signstatus=(String) session.getAttribute("signin");
                                          int profid=logbean.getProfileid();
                                          String signintime=new AttendanceProcessing().getLoginDateTime(profid);
                                          String workingtime=new AttendanceProcessing().getWorkingTime(profid);
                                          if(signstatus.equalsIgnoreCase("Alreadysignedin")){
				...
				<div class="head-menu">
				<ul class="menu">
                                    <li><a id="cur" href="home.jsp"><img src="images/icons/home.png" alt="home" class="icon"/>Home</a></li>
			...
			<div class="center-body">
				...
				<div class="right-container">
                              <%
                                if(signstatus.equalsIgnoreCase("NotsignedIn")){%>
                                <div id="dialog-confirm" title="RVA Attendance">
 
                               </div><%}%>	
			        <div id="dialog-confirm-signout" title="RVA Attendance" style="display: none;">
 
                              </div>
		 	<%@ include file="jspfiles/home1.jsp"%>
				</div>
				<div class="footer">
